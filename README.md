...
- **标点符号** — 编辑半角/全角标点规则
- **配置备份** — 手动备份、备份列表、差异对比、一键回滚、部署前自动备份
- **词典管理** — 词条浏览/搜索/编辑、批量删除低频词条、导出码表、清空词典
- **同步管理** — 基于共享文件夹的多设备词典同步，支持配置上传/下载/合并
- **高级设置** — 同步用户数据、重置配置、配置文件状态
...
- ✅ 功能开发完成，覆盖 RimeVision 全部核心功能 + 备份/词典/同步三大新模块
- ✅ 多轮无偏代码审查，所有发现的问题已修复（共 19 项）
